<template>
  <div class="trip-wrapper">
    ...
    <div class="main-content">
      <p class="question">📧 <strong>초대할 사람의 이메일을 입력해주세요</strong></p>
      ...
      <p v-if="showNextError" class="error">최소 한 명 이상의 이메일을 추가해주세요.</p>

      <div class="email-list" v-if="store.tripData.invitedEmails.length">
        <ul>
          <li v-for="(email, index) in store.tripData.invitedEmails" :key="index">
            {{ index + 1 }}. {{ email }}
